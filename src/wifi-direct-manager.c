...
int wfd_local_set_display(wifi_direct_display_type_e type, int port, int hdcp)
{
	__WDS_LOG_FUNC_ENTER__;
...
int wfd_manager_enable_wifi_display(int enable)
{
	__WDS_LOG_FUNC_ENTER__;
	wfd_device_s * device = g_manager->local;
	wfd_display_info_s * display;
	...
	res = wfd_oem_enable_wifi_display(g_manager->oem_ops, enable);
	if (res < 0) {
